...
# Test executer 
# Run executer contantly in different process:
#   - with fixed frequancy
#   - with maximal speed
...
# CANRPy should collect commands from all devices and provide them interfaces to virtual bus
# if there is now
...
class CANRPy:
    ...
    def add_device(self, can_device):
        pass

    def build_spi_frame(self):
        pass
